...
namespace ServiceRest_054_MuhammadFerdyYosa
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source = desktop-gb128hp\\mssql2014; Initial Catalog =\"TI UMY\"; Persist Security Info = True; User ID = sa; Password=FErdy277");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source = desktop-gb128hp\\mssql2014; Initial Catalog =\"TI UMY\"; Persist Security Info = True; User ID = sa; Password=FErdy277");
